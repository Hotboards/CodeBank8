...
//#include "system.h"
#include "usb_keyboard/usb_config.h"          // Must be defined by the application

#include "usb_keyboard/usb_common.h"         // Common USB library definitions
#include "usb_keyboard/usb_ch9.h"            // USB device framework definitions

#if defined( USB_SUPPORT_DEVICE )
    #include "usb_keyboard/usb_device.h"     // USB Device abstraction layer interface
#endif
...
#include "usb_keyboard/usb_hal.h"            // Hardware Abstraction Layer interface
