...
#endif
#define SET_ENABLE()                    Gpios_SetPin(_6800_E_P, _6800_E_B)
#define CLR_ENABLE()                    Gpios_ClearPin(_6800_E_P, _6800_E_B)
#define RS_FOR_DATA()                   Gpios_SetPin(_6800_RS_P, _6800_RS_B)
#define RS_FOR_COMMAND()                Gpios_ClearPin(_6800_RS_P, _6800_RS_B)
#define RW_FOR_WRITE()                  Gpios_ClearPin(_6800_RW_P, _6800_RW_B)
#define RW_FOR_READ()                   Gpios_SetPin(_6800_RW_P, _6800_RW_B)

#define _6800_Delay()                   Delays_us(1)
